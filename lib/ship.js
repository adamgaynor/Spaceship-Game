...
(function () {
  ...
  Ship.prototype.loadImages = function () {
    ...
    this.queue.loadFile({id: "spaceship-sheet", src:"assets/spaceships.png"});
  ...
  Ship.prototype.handleImageQueue = function (event) {
    ...
    this.spaceshipSpriteSheet = this.queue.getResult("spaceship-sheet");
    var data = this.generateShipSpriteSheet();
  };
  ...
  Ship.prototype.generateShipSpriteSheet = function () {
    var data = {
      images: ["assets/spaceships.png"],
