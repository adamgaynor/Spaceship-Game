...
(function () {
  ...
  var GameView = Asteroids.GameView = function (stage) {
    ...
    this.startButton = new createjs.DOMElement(startButton);
    var stageElement = document.getElementById("gameCanvas");
    this.stageElement = new createjs.DOMElement(stageElement);
    this.stageElement.htmlElement.setAttribute("style", "");

    console.log(this.startButton);
    // console.log(this.stageElement);
  };
